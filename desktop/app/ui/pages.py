from .page_calibration_responsive import CalibrationPage
...
from .page_mapping_product import MappingPage
from .page_profiles_responsive import ProfilesPage
from .page_settings_product import SettingsPage

__all__ = [
    "CalibrationPage", "DashboardPage", "DevicePage", "DiagnosticsPage",
    "JoystickPage", "MappingPage", "ProfilesPage", "SettingsPage",
]
